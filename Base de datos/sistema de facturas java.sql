...
create database bd_sistema_factura;
-- usamos la base de datos
use bd_sistema_factura;
...
values("Alan", "Leiva", "Neitor30", "12345", "72603388", 1);

select * from tb_usuario; 

select  usuario, password from tb_usuario where usuario = "Neitor30" and password = "12345";
